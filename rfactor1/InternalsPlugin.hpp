...
struct VehicleScoringInfoV2 : public VehicleScoringInfoV1 // for noobs: VehicleScoringInfoV2 contains everything in VehicleScoringInfo, plus the following:
{
...
{
  VehicleScoringInfoV1 *mVehicle;  // array of vehicle scoring info's
};
